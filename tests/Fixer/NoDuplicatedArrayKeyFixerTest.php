 ...
 */
#[CoversClass(NoDuplicatedArrayKeyFixer::class)]
final class NoDuplicatedArrayKeyFixerTest extends AbstractFixerTestCase
{
    ...
    public static function provideFixCases(): iterable
    {
        ...
        foreach (['1', '1.0', '"foo"', "'foo'", 'b"foo"', "B'foo'", 'KEY_123', 'Constants::CONFIG_KEY', 'Library\\Constants::CONFIG_KEY'] as $duplicatedKey) {
            yield [
                \sprintf('<?php
                $x = [
