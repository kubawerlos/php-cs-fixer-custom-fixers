...
',
    ...
    private function updateContent(string $content, ?string $startCharacter, ?string $endCharacter, int $groupSize, ?bool $addSeparators, bool $fromRight = true): string
    {
        ...
        $substringToUpdate = \call_user_func('substr', $content, $startPosition, $endPosition - $startPosition);
        ...
        return \call_user_func('substr', $content, 0, $startPosition) . $substringToUpdate . \call_user_func('substr', $content, $endPosition);
    }
